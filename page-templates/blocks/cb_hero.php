...
$clr = get_field('button_colour');
?>
<section class="hero">
    <div class="container-xl mb-5">
        <div class="layer-1">
            <h1 data-aos="fade"><span><?=get_field('title')?></span></h1>
        </div>
        <div class="layer-2">
            <div class="text-center">
                <a class="btn btn-<?=$clr?>" href="<?=$link['url']?>">
                    <span class="btn-text"><?=$link['title']?></span>
                    <span class="btn-arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16"><defs></defs><defs><path id="gkmzs" d="M13 9V7h3v2h-3zM7.03233022 1l1.43859292 1.43076034-4.58011387 4.55637467H10v2.02471813H3.89080927l4.58011387 4.55637466L7.03233022 15 0 8l.71777145-.71538017.71878813-.71639202L7.03233022 1z"></path></defs><use fill="currentColor" fill-rule="evenodd" transform="matrix(-1 0 0 1 16 0)" xlink:href="#gkmzs"></use></svg>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="text-center mb-5">
        <div onclick="scrollSmoothTo('content')">
            <svg id="mouse-icon" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220.84 451.35">
                <defs><style>.cls-1 {fill: #fff;}.cls-1,.cls-2 {stroke-width: 0px;}</style></defs>
                <g id="mouse">
